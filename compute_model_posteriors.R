setwd("/Users/DanielPaluh/revbayes/discrete_morphology_frog/")
getwd()

out_file = "model_comparison_results3.txt"

log = read.table("output/ase_freeK_RJ.log", header=TRUE, sep="\t", stringsAsFactors=FALSE)
